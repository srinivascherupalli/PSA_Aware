trigger AsBgCourseEnrollmentTrigger on AS_BG_Course_Enrolment__c (after delete, after insert, after undelete,
after update, before delete, before insert, before update) {
  // This should be used in conjunction with the TriggerHandlerComprehensive.cls template
  // The origin of this pattern is http://www.embracingthecloud.com/2010/07/08/ASimpleTriggerTemplateForSalesforce.aspx

  AsBgCourseEnrollment handler = new AsBgCourseEnrollment(Trigger.isExecuting, Trigger.size);
