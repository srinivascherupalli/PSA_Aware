({
    doInit : function(component, event, helper) {
       ...
       // component.set("v.startDate",SBQQ__StartDate__c);
        if(frequency=='annual'){
            frequency='annually';
        }
        ...
        if(userprofile!=null){
            ...
            if(userprofile.country!="Australia"){
                ...
                var selprod = selectedList.SBQQ__Product__r.ProductCode;
...
/*        var navEvent = $A.get("e.c:PSA_NavigationEvent");
    ...
    onNoThankYou: function(component, event, helper){
        helper.deletePremiumInsurance(component, event);
    ...
    dateChange: function(component, event, helper) {
        ...
        helper.deletePremiumInsuranceOnDateChange(component, event);
